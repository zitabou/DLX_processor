...
# Register-register instructions
  "nand" => "r,0x01",					# added nand instruction
  "nor"  => "r,0x02",					# added nor instruction
  "xnor" => "r,0x03",					# added xnor instruction
  "sll"  => "r,0x04",
  "srl"  => "r,0x06",
  "sra"  => "r,0x07",
  "ror"  => "r,0x08",					# added rotation instruction
  "mult" => "r,0x1f",					# added rotation instruction
  "add"  => "r,0x20",
  "addu" => "r,0x21",
  "sub"  => "r,0x22",
  "subu" => "r,0x23",
...
# General instructions
  ...
  "sf"   => "s,0x2e",
  "sd"   => "s,0x2f",
  "nandi"=> "i,0x30",					# added nandi instruction
  "nori" => "i,0x31",					# added nori instruction
  "xnori"=> "i,0x32",					# added xnori instruction
  "multi"=> "i,0x35",					# added muli instruction
  "rori"=> "i,0x36",					# added rori instruction
  "itlb" => "n,0x38",
  "sltui" => "i,0x3a",
  "sgtui" => "i,0x3b",
  "sleui" => "i,0x3c",
